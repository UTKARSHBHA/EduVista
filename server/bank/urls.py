...
from .views import SubjectListCreateView, StandardListCreateView,  TopicListCreateView, ChapterListCreateView, QuestionListCreateView, OptionListCreateView, SubjectDeleteView, StandardDeleteView, TopicDeleteView, ChapterDeleteView, QuestionDeleteView, OptionDeleteView, QuestionDetailView
...
urlpatterns = [
    ...
    path('options/<int:pk>/delete/', OptionDeleteView.as_view(), name='delete_option'),
